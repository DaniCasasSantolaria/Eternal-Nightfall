...
public class Bandit : MonoBehaviour
{
    ...
    [SerializeField] float m_coyoteTime = 0.2f; // Tiempo de gracia para saltar después de dejar el suelo
    [SerializeField] float m_jumpBufferTime = 0.2f; // Tiempo de buffer para registrar el intento de salto
    ...
    void Update()
    {
        ...
        // Register jump input with buffer time
